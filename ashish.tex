...
% \section{\sc Technical Abilities}
% \begin{list2}
% \item {\bf Languages}:  Python (Full-Stack), R, SQL, C/C++, JavaScript.
% \item {\bf Machine Learning Frameworks}: NLTK, Scikit-learn, Pandas, Matplotlib, Flask.
% \item {\bf Deep Learning Frameworks}: Keras, Tensorflow.
% \item {\bf Operating Systems}:  Windows: 7/8/10; Linux Distros.: Ubuntu, Kali.
% \item {\bf Services}:  AWS, Docker.
% \item {\bf Courses Completed}: Machine Learning, Advanced ML, Deep Learning, Artificial Intelligence.
...
% \vspace{-.1in}
% \begin{tabular}{@{}p{3in}p{3in}}
% {\bf Dr. Stewart Massie} & {\it} {\bf Dr. Thanh Nguyen} \\ 
% Senior Research Fellow, CSDM & {\it} Research Fellow, CSDM \\
% Robert Gordon University, Aberdeen, United Kingdom & {\it} Robert Gordon University, Aberdeen, United Kingdom\\
% {\it E-mail:} s.massie@rgu.ac.uk & {\it E-mail:} t.nguyen11@rgu.ac.uk \\
% \end{tabular}
